...
public class ExtrasController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        nombreExtra = Carta_ExtrasController.nombreExtra;
        
        //MOSTRAR LA INFORMACIÓN DE LOS EXTRAS------------
        
        try {
            
            Connection cn = Conexion.conectar();
            PreparedStatement pst = cn.prepareStatement(
                    "select * from hamburguesas where nombre = '" + nombreExtra + "'");
            ...
            System.err.println("Error al cargar El Extra." + e);
