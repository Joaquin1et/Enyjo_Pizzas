 ...
 * @author joaqu
 */
public class HamburguesasController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        nombreBurguer = CartaController.nombreBurguer;
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "select * from hamburguesas where nombre = '" + nombreBurguer + "'");
